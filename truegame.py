...
#                 return variable _means that we are returning the variable to back to calling function.
...
def describe_game(name):
    ...
    """
    # Meaning, if we not already have this user's name,
    # then they are a new player and we need to get their name
    if name != "":
        print("\nThank you fopr playing again, ()!".format(name))
    else:
            stop = True
            while stop:
                if name =="":
...
def score(nice,mean,name):
    # score function is being passed the value stored withing the 3 variables
